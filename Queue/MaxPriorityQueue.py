...
'''
Minimum Priority Queue class: an element with high priority is served before an element with low priority
'''
class MaxPriorityQueue:
    ...
    def dequeue(self):
        ...
        if self.is_empty():
            ...
            max_priority = self.queue.pop(idx)
            hashmap[max_priority.data] = max_priority.priority
...
my_min_priorityQ = MaxPriorityQueue()
